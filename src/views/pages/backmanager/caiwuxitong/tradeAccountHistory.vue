  ...
  <div class="tgzc">
    ...
    <div class="w_c">
      <el-table :data="tableData" style="width:100%">
        ...
        <el-table-column prop="userid" label="划转UID"> </el-table-column>
        <el-table-column prop="coinname" label="币种"> </el-table-column>
        <el-table-column prop="optype_s" min-width="120px" label="类型"> </el-table-column>
        <el-table-column prop="amount" label="变化数量"> </el-table-column>
        <el-table-column prop="amountafter" min-width="120px" label="剩余账户资产">
          <template slot-scope="scope">
            <span>{{Number(scope.row.amountafter).toFixed(6)}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="amountafter" min-width="120px" label="剩余已实现盈亏">
          <template slot-scope="scope">
            <span>{{Number(scope.row.amountafter).toFixed(6)}}</span>
          </template>
        </el-table-column>
        <!-- <el-table-column prop="remark" label="用途归类"> </el-table-column> -->
...
export default {
  ...
  methods: {
    ...
    getData(){
      ...
      this.$api.getTradeAccountHistory({
       "tag":{
