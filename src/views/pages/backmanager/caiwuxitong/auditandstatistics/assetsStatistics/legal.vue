...
<template>
  <div class="lsjl">
    ...
    <div id="myChart" :style="{width: '1100px', height: '700px'}" ref="myChart">></div>
    <div class="w_menu">
      <el-date-picker
        v-model="time"
        type="daterange"
    ...
    <div id="wcdiv_lsjl" class="w_c">
      ...
      >
        ...
        <el-table-column prop="cycle_amount" label="清算周期法币购买USDT数量" min-width="200"></el-table-column>
        <el-table-column prop="total_amount" label="累计法币购买USDT数量" min-width="180"></el-table-column>
        <el-table-column prop="difference" label="累计全网法币购买标准差" min-width="180"></el-table-column>
        <el-table-column prop="total_average" fixed="right" label="累计全网法币购买人均数量" min-width="180"></el-table-column>
      </el-table>
    </div>
    <div class="w_page">
      <el-pagination
...
<script>
import { GETLEGALSTATISTICS } from "@/constant";
export default {
  data() {
    return {
      time: [],
