  ...
  <div class="lsjl">
    ...
    <div id="wcdiv_lsjl" class="w_c">
      ...
      >
        ...
        <el-table-column prop="cycle_amount" label="清算周期转出USDT数量" min-width="180"></el-table-column>
        <el-table-column prop="total_amount" label="累计转出USDT数量" min-width="180"></el-table-column>
        <el-table-column prop="difference" label="累计全网转出标准差" min-width="180"></el-table-column>
        <el-table-column prop="total_average" fixed="right" label="累计全网转出人均数量" min-width="180"></el-table-column>
      </el-table>
    </div>
    <div class="w_page">
      <el-pagination
...
<script>
import { GETTRANSFEROUTSTATISTICS } from "@/constant";
export default {
  data() {
    return {
      time: [],
  ...
  mounted() {
    ...
    this.$register(this);
    this.msg = [GETTRANSFEROUTSTATISTICS];
  ...
  methods: {
    ...
    getData() {
      ...
      this.$api.getStatisticsData({
        tag: {
          dataType: GETTRANSFEROUTSTATISTICS,
          ttype: 4,
