  ...
  <div class="lsjl">
    ...
    <div id="wcdiv_lsjl" class="w_c">
      ...
      >
        ...
        <el-table-column prop="total_amount" label="全网账户资产数量" min-width="180"></el-table-column>
        <el-table-column prop="difference" label="全网账户资产标准差" min-width="180"></el-table-column>
        <el-table-column prop="total_average" fixed="right" label="全网账户资产人均数量" min-width="180"></el-table-column>
      </el-table>
    </div>
    <div class="w_page">
      <el-pagination
