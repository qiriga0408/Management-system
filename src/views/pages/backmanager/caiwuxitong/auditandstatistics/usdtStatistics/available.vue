  ...
  <div class="lsjl">
    ...
    <div id="wcdiv_lsjl" class="w_c">
      ...
      >
        ...
        <el-table-column prop="total_amount" label="可用余额USDT数量" min-width="180"></el-table-column>
        <el-table-column prop="difference" label="全网可用余额标准差" min-width="180"></el-table-column>
        <el-table-column prop="total_average" fixed="right" label="全网可用余额人均数量" min-width="180"></el-table-column>
      </el-table>
    </div>
    <div class="w_page">
      <el-pagination
