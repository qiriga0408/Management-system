  ...
  <div class="lsjl">
    ...
    <div id="wcdiv_lsjl" class="w_c">
      ...
      >
        ...
        <el-table-column prop="cycle_amount" label="清算周期已实现盈亏USDT数量" min-width="180"></el-table-column>
        <el-table-column prop="total_amount" label="累计已实现盈亏USDT数量" min-width="180"></el-table-column>
        <el-table-column prop="difference" label="累计全网已实现盈亏标准差" min-width="180"></el-table-column>
        <el-table-column prop="total_average" fixed="right" label="累计全网已实现盈亏人均数量" min-width="180"></el-table-column>
      </el-table>
    </div>
    <div class="w_page">
      <el-pagination
